...
The machinery (`scripts/`, `../.kb/templates`, `../.kb/schema`) is scaffolded
from the upstream knowledge-base repo — see its `README.md` for the design
rationale, architecture diagrams, and full layout. Everything under `memory/`
and `../.kb/generated/` is this repo's own data.
